...
- **Focus:** What's in scope and what isn't? Is the vision sharp or scattered?
- **Simplicity:** Can the product be explained in one sentence? Does it do ONE thing insanely well?
- **The no-list:** What was deliberately killed? The no-list reveals taste.
- **Stage-worthiness:** Would you demo this at a keynote?

The team lead will only ask questions where the answer ISN'T already in the project docs. If CLAUDE.md already describes the product's focus and what was cut, no questions are needed — you review from the docs.
