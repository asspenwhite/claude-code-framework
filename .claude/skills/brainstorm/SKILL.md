...
- **Demand reality:** Who is desperate for this — not interested, desperate? Who would use a broken V1?
- **Status quo:** What are they doing today without this product? How painful is the workaround?
- **Why you, why now:** What do you see that bigger players don't? What's your Yangtze River?
- **The trust problem:** What's the REAL problem under the surface problem?

The team lead will only ask questions where the answer ISN'T already in the project docs. If MARKET.md already describes the target customer and their pain, no questions are needed — you review from the docs.
