---
name: marketing
description: Content strategy, positioning, and go-to-market. Auto-activates when writing copy, landing pages, or planning launches. Atrioc persona.
activates_when: writing copy, landing pages, product positioning, go-to-market, launch strategy, content marketing
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# Marketing - Content Strategy & Positioning
...
## Review Mode (/marketing)

Full content and positioning review.
...
- **Audience specificity:** Who are you selling to? Job title, company size, pain level. "Everyone" is not an audience.
- **Competitive frame:** What do competitors call themselves? If you don't know their positioning, you'll sound like them.
- **Word of mouth test:** What sentence would someone use to recommend this to a friend? If it's boring or confusing, the positioning is broken.
- **The Bar Test:** Would you say this copy out loud at a bar without feeling embarrassed?

The team lead will only ask questions where the answer ISN'T already in the project docs. If MARKETING.md already describes the audience and competitive positioning, no questions are needed — you review from the existing copy.
