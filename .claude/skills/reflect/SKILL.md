...
- **Known risks:** What's the biggest risk you're aware of but haven't addressed? The "swimming naked" question.
- **Kill criteria:** What would make you abandon this entirely? Buffett walks away from deals — knowing the walk-away point matters.
- **The moat:** What's the one thing that went right that you want to protect? The compounding advantage.
- **Mistakes inventory:** What went wrong that nobody's talked about yet? Mistakes on page 1, not page 47.

The team lead will only ask questions where the answer ISN'T already in the project docs or the deliberation reports. If the reports already surfaced all risks and the user's priorities are clear from the discussion, no questions are needed.
